...
app.controller('MainCtrl', ['$scope', function ($scope) {
  ...
  $scope.gridOptions.columnDefs = [
    ...
    { name: 'SprintNumber', enableCellEdit:false,width: '10%'},
    { name: 'SprintStartDate', type:'date', cellFilter:'date:"yyyy-MM-dd"',width: '20%' },
    { name: 'SprintEndDate', type:'date', cellFilter:'date:"yyyy-MM-dd"',width: '20%'},
